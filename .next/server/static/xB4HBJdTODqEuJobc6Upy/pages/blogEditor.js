...
/* harmony import */ var _components_hoc_withAuth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
...
function (_React$Component) {
  ...
  _createClass(BlogEditor, [{
    ...
    value: function saveBlog(story, heading) {
      ...
      Object(_actions__WEBPACK_IMPORTED_MODULE_7__[/* createBlog */ "a"])(blog, lockId).then(function (createdBlog) {
        _this2.setState({
          isSaving: false
        });

        react_toastify__WEBPACK_IMPORTED_MODULE_6__["toast"].success('Blog Saved Succesfuly!');
        _routes__WEBPACK_IMPORTED_MODULE_4__["Router"].pushRoute("/blogs/".concat(createdBlog._id, "/edit"));
      }).catch(function (err) {
        _this2.setState({
          isSaving: false
        });
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_slate_editor_Editor__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
        isLoading: isSaving,
        save: this.saveBlog
      })));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_components_hoc_withAuth__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])('siteOwner')(BlogEditor));
